...
const FontStyles = ['HeadlineL', 'HeadlineM', 'HeadlineS', 'TitleXL', 'TitleL', 'TitleM', 'TitleS', 'LabelL', 'LabelM', 'LabelS', 'BodyL', 'BodyM'];
...
const createButtonTypography = (children: any, onPress: () => void) => {
  return (
    <View style={{ flexDirection: 'row', justifyContent: 'center', alignItems: 'center' }}>
      <TouchableOpacity onPress={onPress} style={{ flexGrow: 0, flexShrink: 1, paddingHorizontal: 3, paddingVertical: 7 }}>
        {children}
      </TouchableOpacity>
    </View>
  );
...
export const [HeadlineL, HeadlineM, HeadlineS, TitleXL, TitleL, TitleM, TitleS, LabelL, LabelM, LabelS, BodyL, BodyM] = FontStyles.map(
  (type: string) => createTypographyComponent(type),
);
export { FontStyles };
